...
effect =
  Support.prepare!(spec, runtime, :http_read, "example payload")
  |> Support.print_effect("PREPARED")
...
Support.assert_equal!(
  effect.version_vector,
  ready.version_vector,
  "version vector remains bound across evaluation"
)
