...
install -d -m 0700 /var/lib/autonomic /var/lib/autonomic/rootfs /var/lib/autonomic/kernel
...
Next:
  ...
  2. create a minimal trusted rootfs with /workspace /run /tmp /proc mountpoints
