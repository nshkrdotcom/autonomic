defmodule Autonomic.Store.CodingAgentReferenceTest do
  ...
  setup do
    ...
    old_state_dir = Application.fetch_env!(:autonomic, :state_dir)
    old_verify = Application.get_env(:autonomic, :automatic_verification, false)
    Application.put_env(:autonomic, :state_dir, state_dir)
    Application.put_env(:autonomic, :automatic_verification, true)
    ...
    on_exit(fn ->
      ...
      Application.put_env(:autonomic, :state_dir, old_state_dir)
      Application.put_env(:autonomic, :automatic_verification, old_verify)
